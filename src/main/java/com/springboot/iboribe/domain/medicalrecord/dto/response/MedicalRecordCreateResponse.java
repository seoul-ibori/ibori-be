...
@Getter
@Builder
@Schema(title = "MedicalRecordCreateResponse: 사용자 진료 일정 생성 응답 DTO")
public class MedicalRecordCreateResponse {
  ...
  public static MedicalRecordCreateResponse from(MedicalRecord medicalRecord) {
    return MedicalRecordCreateResponse.builder()
