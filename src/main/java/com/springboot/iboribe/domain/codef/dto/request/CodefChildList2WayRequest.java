...
@Getter
@NoArgsConstructor
@Schema(title = "CodefChildList2WayRequest: CODEF 자녀 목록 조회 2차 요청 DTO")
public class CodefChildList2WayRequest {
  ...
  @Schema(description = "보호자 이름", example = "신채린")
  private String userName;

  @NotBlank(message = "생년월일은 필수입니다.")
  @Schema(description = "보호자 생년월일 YYYYMMDD", example = "20030709")
