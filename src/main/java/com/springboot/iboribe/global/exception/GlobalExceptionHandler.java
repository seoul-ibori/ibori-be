...
import com.springboot.iboribe.global.response.BaseResponse;

import lombok.extern.slf4j.Slf4j;

@Slf4j // 로그를 남기기 위함
@RestControllerAdvice // Controller에서 발생한 에러에 대해 전역 예외 처리를 위해
public class GlobalExceptionHandler { // 예외 처리 핸들러
  // 커스텀 예외
